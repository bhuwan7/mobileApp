...
function dspResult() {
  if(wkFirst === "0" && wkBefore === "0") {
    elementcalcLog.innerHTML = elementcalcLog.innerHTML + Number(elementResult.innerHTML);//calcLog
    calculator();
    wkCalc = "=";//saves equal
    wkBefore = "1";
  }
...
// 【Ｅ】自分で考える
function clear() {
  elementResult.innerHTML = 0;//clears
  elementcalcLog.innerHTML = "";//clears
  wkFirst = "1";
  wkTotal = 0;
  wkCalc = "+";
  wkBefore = "1";
